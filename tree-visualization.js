...
var updateTree = function() {
  ...
  link
    .transition() // Update new position of old links
    .duration(duration)
  ...
  link
    .enter()
    .append('path') // Add new element for new data
    .attr('class', 'link')
    .transition()
    .duration(duration)
    .attrTween('d', function(d) {
  ...
  node
    ...
    .attr('transform', function(d) {
      setTimeout(function() {
        // Finish transition, update old position of this node
...
var handleInsert = function(event) {
  ...
  console.log(value);
  if (num) {
    document.getElementById('insertInput').value = ''; //clear the box
